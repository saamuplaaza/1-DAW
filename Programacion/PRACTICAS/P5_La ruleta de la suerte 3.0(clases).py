...
class Juego:
    ...
    def __init__(self, turno, fraseOriginal, fraseDescubierta, numJugadores, letrasDichas, casillasRuleta):
        ...
        self.letrasDichas = letrasDichas
        self.casillasRuleta = casillasRuleta
    
    def set_tirar(self,casillasRuleta):
        """Tira la ruleta y devuelve el resultado.
        
        Returns:
            El resultado de la ruleta.
        """
        return random.choice(casillasRuleta)
