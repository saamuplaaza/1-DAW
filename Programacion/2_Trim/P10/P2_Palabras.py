...
def vecesPalabra(buscar, listaLimpia, sinTilde):
    repeticion = 0
...
def contarPalabras(listaLimpia, sinTilde):
...
def quitarTildePalabra(palabra):
    i=0
...
def cambiarVocal(vocal, palabraSinTilde):
    i=0
...
def esPalindrimo(palabraPalindromo):
    # Si la palabra es un número, no puede ser palíndromo.
    if palabraPalindromo.isalpha()==False:
        return False
    else:
