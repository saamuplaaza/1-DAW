...
public class EliminarEmpleado extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().length() != 0) {
            bd.conectar();
            int emp_no = Integer.parseInt(jTextField1.getText());

            if (bd.EliminarEmpleado(emp_no) == 0) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarEmpleado dialog = new EliminarEmpleado(new javax.swing.JFrame(), true);
